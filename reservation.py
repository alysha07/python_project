from notifications import reservation_confirmation_email
...
class TableReservation:
    ...
    def take_reservation(self):
        ...
        email = input("Enter customer email: ")        # ← NEW
